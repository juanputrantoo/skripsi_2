<div class="content">
    <div class="container tawaran">
        <div class="sub-judul">
            ...
            <p class="mb-0 ml-1 my-auto">Sudah di proses kontrak</p>
        </div>
            ...
            <div class="card m-2 shadow" style="border: 1px solid #006266;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center my-auto">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#deskripsi<?php echo $detail['idKontrak']; ?>">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form method="POST" action="<?php echo base_url('pl/tawaran/kontrak/terima/' . $detail['idKontrak']); ?>" enctype="multipart/form-data">
