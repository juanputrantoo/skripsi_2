...
$akun = $this->m_pekerjaLepas->detailAkun($id);
$notifPenawaranBaru = $this->m_tawaranPekerjaan->detailByStatusPL($id, 0);
$notifPenawaranBaru = count($notifPenawaranBaru);
$notifPenawaranTerima = $this->m_tawaranPekerjaan->detailByStatusPL($id, 1);
$notifPenawaranTerima = count($notifPenawaranTerima);
$notifProsesKontrak = $this->m_kontrak->detailByStatusPL($id, 0);
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?php if ($this->uri->segment(2) == "home") {
                    ...
                    <a class="nav-link" href="<?php echo base_url() . 'pl/home'; ?>">Beranda</a>
                </li>
                <li class="nav-item <?php if ($this->uri->segment(2) == "cariPekerja" || $this->uri->segment(2) == "searchCariPekerja") {
                                        echo "active";
                                    } ?>">
                    <a class="nav-link" href="<?php echo base_url() . 'pl/cariPekerja'; ?>">Lihat Pekerja Lain</a>
                </li>
                <li class="nav-item dropright <?php if ($this->uri->segment(3) == "masuk" || $this->uri->segment(3) == "terima" || $this->uri->segment(3) == "kontrak") {
                                                    echo "active";
                                                } ?>">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item text-dark <?php if ($this->uri->segment(3) == "masuk") {
                                                                echo "active";
                                                            } ?>" href="<?php echo base_url() . 'pl/tawaran/masuk'; ?>"><i class="fas fa-paper-plane mr-2"></i>
                            Baru Masuk
                        ...
                        <a class="dropdown-item text-dark <?php if ($this->uri->segment(3) == "terima") {
                                                                echo "active";
                                                            } ?>" href="<?php echo base_url() . 'pl/tawaran/terima'; ?>"><i class="fas fa-clipboard-check mr-2"></i>
                            Diterima
                        ...
                        <a class="dropdown-item text-dark <?php if ($this->uri->segment(3) == "kontrak") {
                                                                echo "active";
                                                            } ?>" href="<?php echo base_url() . 'pl/tawaran/kontrak'; ?>"><i class="fas fa-file-contract mr-2"></i>
                            Proses Kontrak
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown no-arrow <?php if ($this->uri->segment(2) == "profileDiri" || $this->uri->segment(2) == "profileKategori" || $this->uri->segment(2) == "profileHarga" || $this->uri->segment(2) == "profilePortofolio" || $this->uri->segment(2) == "riwayatPenawaran" || $this->uri->segment(2) == "riwayatKontrak") {
                                                            echo "active";
                                                        } ?>">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        <a class="dropdown-item text-dark <?php if ($this->uri->segment(2) == "profileDiri" || $this->uri->segment(2) == "profileKategori" || $this->uri->segment(2) == "profileHarga" || $this->uri->segment(2) == "profilePortofolio") {
                                                                echo "active";
                                                            } ?>" href="<?php echo base_url('pl/profileDiri/' . $this->session->userdata('id')); ?>">
                        ...
                        <a class="dropdown-item text-dark <?php if ($this->uri->segment(2) == "riwayatPenawaran") {
                                                                echo "active";
                                                            } ?>" href="<?php echo base_url('pl/riwayatPenawaran/' . $this->session->userdata('id')); ?>">
                        ...
                        <a class="dropdown-item text-dark <?php if ($this->uri->segment(2) == "riwayatKontrak") {
                                                                echo "active";
                                                            } ?>" href="<?php echo base_url('pl/riwayatKontrak/' . $this->session->userdata('id')); ?>">
