<div class="content">
    <div class="container tawaran">
        <div class="sub-judul">
            ...
            <p class="mb-0 ml-1 my-auto">Tawaran yang sudah Anda terima</p>
        </div>
        <?php if (count($detail) < 1) {
            ...
            <div class="card-body text-center d-flex" style="color: gray;">
                <div class="my-auto mx-auto">
                    ...
                    <p class="m-3"><b>Belum ada lagi tawaran yang Anda terima</b></p>
                </div>
            </div>
        </div>
        ';
            ...
            <div class="card m-2 shadow" style="border: 1px solid #006266;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 d-inline-block text-center my-auto">
                    ...
                    <div class="modal fade" id="cancel<?php echo $detail['idTawaran']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <form method="POST" action="<?php echo base_url('pl/tawaran/terima/cancel/' . $detail['idTawaran']); ?>" enctype="multipart/form-data">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="alasanBatal" placeholder="Tulisan alasan Anda disini..." required></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
