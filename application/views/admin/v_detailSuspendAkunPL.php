<div class="card shadow mb-4">
    <?php if (isset($detailAkunPL)) : ?>
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('admin/unSuspendPL/' . $detailAkunPL['id']); ?>">
                <div class="modal fade" id="modal-suspend" tabindex="-1" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-body pb-0">
                                <h5>Anda yakin untuk <strong>mengembalikan</strong> akun <?php echo $detailAkunPL['namaLengkap'];?>?</h5>
                            </div>
