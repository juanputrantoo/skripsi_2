                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <form method="POST" action="<?php echo base_url('pk/riwayatPenawaran/cariTanggal/' . $this->session->userdata('id')); ?>" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-5">
                    ...
                    <?php foreach ($detail as $detail) : ?>
                        <tr>
                            ...
                            <td class="align-middle">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#deskripsi<?php echo $detail['idTawaran']; ?>"><i class="fas fa-eye"></i>Tawaran</button>
                            </td>
